              ...
              <tbody>
                <tr>
                  <td>
                    ...
                    <p
                      style="font-size:1.2rem;line-height:1.5;margin-bottom:20px;margin-top:16px">
                      Thank you for applying to speak at the<!-- -->
                      <span style="font-weight:bold"
                        >ETH Enugu Conf/Summit &#x27;25</span
                      >taking place on<!-- -->
                      <span style="font-weight:bold">August 16, 2025</span>.
                      We&#x27;re excited to confirm receipt of your application
                      and sincerely appreciate your interest in sharing your
                      insights with all attendees.
                    </p>
                    <p
                      style="font-size:1.2rem;line-height:1.5;margin-bottom:20px;margin-top:16px">
